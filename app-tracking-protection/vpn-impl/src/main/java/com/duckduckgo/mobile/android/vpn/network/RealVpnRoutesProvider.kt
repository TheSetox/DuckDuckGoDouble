...
class RealVpnRoutesProvider @Inject constructor() : VpnRoutesProvider {
    /**
     ...
     */
    private val includedRoutes: List<Route> = listOf(
     ...
     */
    private val includedTestRoutes: List<Route> = listOf(
        Route(address = "10.0.2.2", maskWidth = 32, lowAddress = "10.0.2.2", highAddress = "10.0.2.2"),
    )

    override fun getRoutes(forTesting: Boolean): List<Route> {
        return if (forTesting) includedTestRoutes else includedRoutes
    }
}
